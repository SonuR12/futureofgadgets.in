      ...
      {items.length === 0 ? (
        <div className="min-h-[60vh] flex items-center justify-center py-8">
          <div className="max-w-2xl w-full text-center px-4">
            ...
            {/* Action Button */}
            <Link href="/" className="inline-flex items-center gap-2 px-6 py-3 sm:px-8 sm:py-3.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-semibold shadow-lg hover:shadow-xl transition-all text-sm sm:text-base">
